...
try:
    from C_saegae_database_manager import db_manager
except Exception:
...
DEFAULT_RSS_URLS: List[str] = [
    'https://www.segye.com/Articles/RSSList/segye_recent.xml', #전체
    'https://www.segye.com/Articles/RSSList/segye_politic.xml', #정치
    'https://www.segye.com/Articles/RSSList/segye_economy.xml', #경제
    'https://www.segye.com/Articles/RSSList/segye_society.xml', #사회
    'https://www.segye.com/Articles/RSSList/segye_international.xml', #국제
    'https://www.segye.com/Articles/RSSList/segye_local.xml', #전국
    'https://www.segye.com/Articles/RSSList/segye_culture.xml', #문화
    'https://www.segye.com/Articles/RSSList/segye_opinion.xml', #오피니언
    'https://www.segye.com/Articles/RSSList/segye_entertainment.xml', #연예
    'https://www.segye.com/Articles/RSSList/segye_sports.xml', #스포츠
    'https://www.segye.com/Articles/RSSList/segye_photo.xml', #포토
    'https://www.sportsworldi.com/Articles/RSSList/sw_recent.xml', #스포츠월드-전체
    'https://www.sportsworldi.com/Articles/RSSList/sw_sports.xml', #스포츠월드-스포츠
    'https://www.sportsworldi.com/Articles/RSSList/sw_entertainment.xml', #스포츠월드-연예
    'https://www.sportsworldi.com/Articles/RSSList/sw_life.xml', #스포츠월드-라이프
    'https://www.segyefn.com/views/rss/all_recent.xml', #세계파이낸스-전체
    'https://www.segyefn.com/views/rss/finance.xml', #세계파이낸스-금융
    'https://www.segyefn.com/views/rss/industry.xml', #세계파이낸스-산업
    'https://www.segyefn.com/views/rss/property.xml', #세계파이낸스-부동산
    'https://www.segyefn.com/views/rss/stock.xml', #세계파이낸스-증권
    'https://www.segyefn.com/views/rss/opinion.xml', #세계파이낸스-오피니언
    'https://www.segyefn.com/views/rss/csr.xml' #세계파이낸스-CSR
]
