...
"""
RSS 기반 뉴스 기사 크롤러
 - 한국경제 RSS 피드를 파싱하여 기사 정보를 추출하고 DB에 저장
 - 입력: RSS URL 또는 RSS URL 목록 파일
 - 출력: 표준출력(JSON Lines) 또는 --out 파일(JSON Lines)
 - 옵션: --save-db 사용 시 DB 저장(C_ke_database_manager.db_manager 활용)
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('ke_rss_crawler.log', encoding='utf-8', mode='w'),
...
DEFAULT_RSS_URLS: List[str] = [
    'https://www.hankyung.com/feed/all-news', #전체
    'https://www.hankyung.com/feed/finance', #증권
    'https://www.hankyung.com/feed/economy', #경제
    'https://www.hankyung.com/feed/realestate', #부동산
    'https://www.hankyung.com/feed/it', #IT/과학
    'https://www.hankyung.com/feed/politics', #정치
    'https://www.hankyung.com/feed/society', #사회
    'https://www.hankyung.com/feed/international', #국제
    'https://www.hankyung.com/feed/sports', #스포츠
    'https://www.hankyung.com/feed/entertainment', #연예
    'https://www.hankyung.com/feed/opinion', #오피니언
]

# 카테고리별 한글명 매핑 (한국경제 RSS용)
RSS_CATEGORY_MAP = {
    'all-news': '전체',
    'finance': '증권',
    'economy': '경제',
...
def main():
    parser = argparse.ArgumentParser(description='한국경제 RSS 피드 크롤러')
    ...
    if not rss_urls:
        logger.info('입력된 RSS URL이 없어 기본 한국경제 RSS URL로 실행합니다.')
