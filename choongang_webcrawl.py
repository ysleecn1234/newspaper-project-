...
"""
URL 기반 뉴스 기사 크롤러
 - 중앙일보 기사 페이지를 크롤링하도록 특화된 셀렉터/패턴 반영
...
try:
    ...
    logger.warning(f"중앙일보 데이터베이스 매니저를 불러올 수 없습니다: {e}")
    db_manager = None
    DB_AVAILABLE = False
...
# 중앙일보 기본 URL 목록 (인자를 주지 않으면 이 목록을 사용)
...
DEFAULT_CATEGORY_URLS: List[str] = [
    'https://www.joongang.co.kr/opinion', # 오피니언
    'https://www.joongang.co.kr/politics', # 정치
    'https://www.joongang.co.kr/money', # 경제
    'https://www.joongang.co.kr/society', # 사회
    'https://www.joongang.co.kr/world', # 국제
    'https://www.joongang.co.kr/culture', # 문화
    'https://www.joongang.co.kr/sports', # 스포츠
    'https://www.joongang.co.kr/lifestyle', # 라이프
    'https://www.joongang.co.kr/people' # 피플
